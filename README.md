...
For comprehensive configuration information, visit the [git-flow-next documentation](https://github.com/gittower/git-flow-next/blob/main/CONFIGURATION.md) which includes:
...
We welcome contributions! Please see the [Contributing Guidelines](https://github.com/gittower/git-flow-next/blob/main/CONTRIBUTING.md) for details on how to get involved.

## Development

For information about the project's architecture and technical overview, see the [Architecture documentation](https://github.com/gittower/git-flow-next/blob/main/ARCHITECTURE.md).

## License

This project is licensed under the BSD 2-Clause License - see the [LICENSE](https://github.com/gittower/git-flow-next/blob/main/LICENSE) file for details.
